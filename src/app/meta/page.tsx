...
const ML_POKEMON_RANKINGS = [
  { name: "Kingambit",        elo: 74716, wr: 51.1, games: 431144 },
  { name: "Garchomp",         elo: 54100, wr: 50.2, games: 1582479 },
  { name: "Scizor",           elo: 50204, wr: 51.4, games: 214494 },
  { name: "Slowbro",          elo: 46908, wr: 55.9, games: 48370 },
  { name: "Gyarados",         elo: 36556, wr: 50.3, games: 697844 },
  { name: "Azumarill",        elo: 33756, wr: 52.5, games: 80846 },
  { name: "Dragapult",        elo: 32820, wr: 50.3, games: 731527 },
  { name: "Milotic",          elo: 31820, wr: 52.6, games: 72490 },
  { name: "Archaludon",       elo: 28404, wr: 57.0, games: 24135 },
  { name: "Hydreigon",        elo: 27804, wr: 55.6, games: 29534 },
  { name: "Snorlax",          elo: 26212, wr: 58.3, games: 18523 },
  { name: "Torkoal",          elo: 25108, wr: 50.8, games: 179187 },
  { name: "Corviknight",      elo: 23996, wr: 57.5, games: 18872 },
  { name: "Garganacl",        elo: 18396, wr: 53.4, games: 30682 },
  { name: "Hisuian Zoroark",  elo: 16076, wr: 53.0, games: 30626 },
  { name: "Whimsicott",       elo: 15500, wr: 51.2, games: 45000 },
  { name: "Hatterene",        elo: 14800, wr: 54.8, games: 22000 },
  { name: "Gliscor",          elo: 14200, wr: 58.0, games: 9251 },
  { name: "Heat Rotom",       elo: 13600, wr: 55.8, games: 14200 },
  { name: "Sylveon",          elo: 13200, wr: 52.0, games: 13600 },
];

const ML_BEST_MOVES = [
  { name: "Dual Wingbeat",  wr: 58.7, uses: 9251 },
  { name: "Body Slam",      wr: 58.3, uses: 18523 },
  { name: "High Horsepower", wr: 58.3, uses: 18523 },
  { name: "Curse",          wr: 58.3, uses: 18523 },
  { name: "Beat Up",        wr: 58.0, uses: 4611 },
  { name: "Electro Shot",   wr: 57.0, uses: 24135 },
  { name: "Iron Defense",   wr: 56.1, uses: 9790 },
  { name: "Volt Switch",    wr: 56.1, uses: 9116 },
  { name: "Poison Jab",     wr: 55.4, uses: 39380 },
  { name: "Body Press",     wr: 55.3, uses: 69355 },
];

const ML_ARCHETYPES = [
  { name: "Aurora Veil",            elo: 9292,  wr: 61.1 },
  { name: "Steel Stall",            elo: 8476,  wr: 59.6 },
  { name: "Dragon Spam",            elo: 7516,  wr: 58.2 },
  { name: "Beat Up",                elo: 7428,  wr: 58.0 },
  { name: "Belly Drum",             elo: 7316,  wr: 57.7 },
  { name: "Hard Trick Room",        elo: 18444, wr: 57.5 },
  { name: "Balance",                elo: 17068, wr: 54.9 },
  { name: "Incineroar Balance",     elo: 11828, wr: 54.2 },
  { name: "Slowbro Trick Room",     elo: 8956,  wr: 53.0 },
];

const ML_BEST_CORES = [
  { pair: "Gliscor + Archaludon",        wr: 72.2, games: 3605 },
  { pair: "Azumarill + Archaludon",      wr: 72.2, games: 3605 },
  { pair: "Corviknight + Archaludon",    wr: 72.2, games: 3605 },
  { pair: "Gyarados + Corviknight",      wr: 72.2, games: 3605 },
  { pair: "Azumarill + Gliscor",         wr: 72.2, games: 3605 },
  { pair: "Arcanine + Hydreigon",        wr: 70.1, games: 3713 },
  { pair: "Azumarill + Hydreigon",       wr: 70.1, games: 3713 },
  { pair: "Hydreigon + Hisuian Zoroark", wr: 70.1, games: 3713 },
];

const ML_INSIGHTS = [
  { type: "meta" as const, text: "Top meta threats: Kingambit (51.1% WR, 74716 ELO), Garchomp (50.2% WR, 54100 ELO), Scizor (51.4% WR, 50204 ELO)", confidence: 95 },
  { type: "synergy" as const, text: "Strongest cores: Gliscor + Archaludon (72.2%), Azumarill + Archaludon (72.2%), Corviknight + Archaludon (72.2%)", confidence: 90 },
  { type: "counter" as const, text: "Mega Kangaskhan hard-counters Trick Room (71.8% WR over 1109 games)", confidence: 85 },
  { type: "counter" as const, text: "Belly Drum hard-counters Mega Metagross (75% WR over 152 games)", confidence: 85 },
  { type: "counter" as const, text: "Rain hard-counters Sand Rush (72.7% WR over 1953 games)", confidence: 85 },
  { type: "pokemon" as const, text: "Overrated Pokémon (high usage, low WR): Flareon (38.9%), Aggron (33.8%), Toxapex (37.6%), Spiritomb (29.4%)", confidence: 80 },
  { type: "meta" as const, text: "Highest win-rate moves: Dual Wingbeat (58.7%), Body Slam (58.3%), High Horsepower (58.3%), Curse (58.3%), Beat Up (58%)", confidence: 85 },
];
