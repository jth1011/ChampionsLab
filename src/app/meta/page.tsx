...
const ML_POKEMON_RANKINGS = [
  { name: "Kingambit",     elo: 39836, wr: 50.5, games: 471758 },
  { name: "Milotic",       elo: 35692, wr: 53.5, games: 61580 },
  { name: "Archaludon",    elo: 34876, wr: 57.3, games: 28570 },
  { name: "Azumarill",     elo: 34148, wr: 52.6, games: 77861 },
  { name: "Garchomp",      elo: 30300, wr: 50.1, games: 1563676 },
  { name: "Slowbro",       elo: 29724, wr: 54.5, games: 39506 },
  { name: "Hydreigon",     elo: 28388, wr: 53.4, games: 49363 },
  { name: "Dragapult",     elo: 25268, wr: 50.2, games: 721857 },
  { name: "Greninja",      elo: 24364, wr: 51.3, games: 111950 },
  { name: "Corviknight",   elo: 23364, wr: 57.1, games: 19193 },
  { name: "Gyarados",      elo: 21100, wr: 50.2, games: 689930 },
  { name: "Snorlax",       elo: 17772, wr: 52.8, games: 35976 },
  { name: "Gliscor",       elo: 13532, wr: 58.2, games: 9224 },
  { name: "Rhyperior",     elo: 12932, wr: 50.5, games: 152377 },
  { name: "Garganacl",     elo: 12900, wr: 52.3, games: 31031 },
  { name: "Torkoal",       elo: 12500, wr: 52.5, games: 176239 },
  { name: "Heat Rotom",    elo: 12100, wr: 55.2, games: 14200 },
  { name: "Alolan Ninetales", elo: 11800, wr: 54.1, games: 12400 },
  { name: "Scizor",        elo: 11600, wr: 52.4, games: 14200 },
  { name: "Sylveon",       elo: 11200, wr: 51.8, games: 13600 },
];

const ML_BEST_MOVES = [
  { name: "Beat Up",        wr: 58.5, uses: 4603 },
  { name: "Roost",          wr: 58.2, uses: 9224 },
  { name: "Electro Shot",   wr: 57.3, uses: 28570 },
  { name: "Dual Wingbeat",  wr: 57.2, uses: 9631 },
  { name: "Iron Defense",   wr: 56.0, uses: 9839 },
  { name: "Icicle Crash",   wr: 55.7, uses: 4914 },
  { name: "Ice Shard",      wr: 55.7, uses: 4914 },
  { name: "Poison Jab",     wr: 55.5, uses: 38960 },
  { name: "Grass Knot",     wr: 55.1, uses: 14511 },
  { name: "Body Press",     wr: 54.8, uses: 28041 },
];

const ML_ARCHETYPES = [
  { name: "Steel Stall",            elo: 8924,  wr: 60.2 },
  { name: "Aurora Veil",            elo: 8764,  wr: 59.9 },
  { name: "Beat Up",                elo: 7780,  wr: 58.5 },
  { name: "Sun Hyper Offense",      elo: 7660,  wr: 58.4 },
  { name: "Dragon Spam",            elo: 7636,  wr: 58.1 },
  { name: "Balance",                elo: 15260, wr: 54.3 },
  { name: "Slowbro Trick Room",     elo: 11164, wr: 54.0 },
  { name: "Tailwind Offense",       elo: 10900, wr: 52.8 },
  { name: "Hyper Offense",          elo: 20044, wr: 52.5 },
];

const ML_BEST_CORES = [
  { pair: "Gliscor + Archaludon",     wr: 70.3, games: 3827 },
  { pair: "Azumarill + Archaludon",   wr: 70.3, games: 3827 },
  { pair: "Corviknight + Archaludon", wr: 70.3, games: 3827 },
  { pair: "Gyarados + Corviknight",   wr: 70.3, games: 3827 },
  { pair: "Azumarill + Gliscor",      wr: 70.3, games: 3827 },
  { pair: "Slowbro + Milotic",        wr: 64.8, games: 4117 },
  { pair: "Arcanine + Hydreigon",     wr: 63.9, games: 4140 },
  { pair: "Azumarill + Hydreigon",    wr: 63.9, games: 4140 },
];

const ML_INSIGHTS = [
  { type: "meta" as const, text: "Top meta threats: Kingambit (50.5% WR, 39836 ELO), Milotic (53.5% WR, 35692 ELO), Archaludon (57.3% WR, 34876 ELO)", confidence: 95 },
  { type: "synergy" as const, text: "Strongest cores: Gliscor + Archaludon (70.3%), Azumarill + Archaludon (70.3%), Corviknight + Archaludon (70.3%)", confidence: 90 },
  { type: "counter" as const, text: "Mega Kangaskhan hard-counters Rain (70.8% WR over 8810 games)", confidence: 85 },
  { type: "counter" as const, text: "Sun Trick Room hard-counters Bulky Balance (72.9% WR over 192 games)", confidence: 85 },
  { type: "counter" as const, text: "Slowbro Trick Room hard-counters Tailwind (81.5% WR over 54 games)", confidence: 85 },
  { type: "pokemon" as const, text: "Overrated Pokémon (high usage, low WR): Flareon (38.8%), Emolga (10.3%), Alakazam (28.9%)", confidence: 80 },
  { type: "meta" as const, text: "Highest win-rate moves: Beat Up (58.5%), Roost (58.2%), Electro Shot (57.3%), Dual Wingbeat (57.2%), Iron Defense (56%)", confidence: 85 },
];
